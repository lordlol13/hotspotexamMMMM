...
def get_student_dashboard_analytics(
    ...
    """
    Get aggregated progress, exam history, average score and trends for the current student.
    Role: Student.
    """
...
def get_teacher_dashboard_analytics(
    ...
    """
    Get group stats, student rankings, pass/fail rates and question difficulty matrices.
    Role: Teacher, Admin, or Student (receives global rankings).
    """
